...
import com.arborcommunity.adpter.MoneyManageAdpter;
 ...
 */
public class MoneyActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    protected void initControl() {
        ...
        txt_title.setText(R.string.moneyManage);//设置app标题
    ...
    protected void initData() {
        ...
        FunctioInfo info = new FunctioInfo(Integer.valueOf(1),"民生银行20180917期理财",new Date(),"http://i1.umei.cc/uploads/tu/201807/9999/551a03416e.jpg","1","收益5.5%");
        FunctioInfo info1 = new FunctioInfo(Integer.valueOf(2),"股市退回两年前水平",new Date(),"http://i1.umei.cc/uploads/tu/201608/72/mckdtwhbwfe.jpg","1","今跌1.2%");
        conversationList.add(info);
        conversationList.add(info1);
        new Thread(new Runnable() {
            @Override
            public void run() {
                contact.setAdapter(new MoneyManageAdpter(conversationList,MoneyActivity.this));
            }
        }).start();
    }
