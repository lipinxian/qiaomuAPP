 ...
 */
public class HomeworkDiscussActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    protected void initControl() {
        ...
        txt_title.setText(R.string.homeworkDiscuss);//设置app标题
    ...
    protected void initData() {
        ...
        FunctioInfo info = new FunctioInfo(Integer.valueOf(1),"物业在装修后不办事",new Date(),"http://i1.umei.cc/uploads/tu/201807/9999/551a03416e.jpg","1");
        FunctioInfo info1 = new FunctioInfo(Integer.valueOf(2),"小孩子在暑假补课培训什么？",new Date(),"http://i1.umei.cc/uploads/tu/201608/72/mckdtwhbwfe.jpg","1");
        conversationList.add(info);
        conversationList.add(info1);
        new Thread(new Runnable() {
            @Override
            public void run() {
                contact.setAdapter(new PolicyNoticeAdpter(conversationList,HomeworkDiscussActivity.this));
            }
        }).start();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.img_back:
                Utils.finish(HomeworkDiscussActivity.this);
                break;
            case R.id.push_button:
                Utils.start_Activity(HomeworkDiscussActivity.this, PushInfoActivity.class,new BasicNameValuePair("infoType","HomeworkDiscuss"));
                break;
            default:
                break;
        }
