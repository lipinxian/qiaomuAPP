package com.arborcommunity.net.utils;
...
public class CommonUtils {
	 ...
	 * @return
	 */
	public static String getMessageDigest(NewsContent message, Context context) {
		String digest = "";
		switch (message.getType()) {
		case LOCATION: // 位置消息
			if (message.direct == NewsContent.Direct.RECEIVE) {
	...
	public static void  getCommunityName(Context context){
